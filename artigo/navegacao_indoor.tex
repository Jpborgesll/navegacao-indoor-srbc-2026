...
\author{
  ...
  Eliomar Araújo de Lima\inst{1},
  Valdemar Vicente Graciano Neto\inst{1},
  Natália Leonel de Paiva\inst{2}
}

\address{
  \inst{1} INF -- Instituto de Informática, Universidade Federal de Goiás (UFG)\\
  Goiânia -- Goiás -- Brasil\\
  \email{\{murillomelo, borges.joao, pedrolukas, eliomar.lima, valdemarneto\}@ufg.br}
  \nextinstitute
  \inst{2} Wayfinder Y Tech\\
  \email{natalialeonelp@gmail.com}
}
...
at UFG's Institute of Informatics, with 4 BLE beacons spaced up to 5 meters apart,
yielding an estimated positioning error of approximately 1.5 meters.
\end{abstract}
...
com 4 beacons BLE posicionados a até 5 metros entre si, apresentando erro de
posicionamento estimado de aproximadamente 1,5 metros.
\end{resumo}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.95\textwidth]{fluxograma.jpeg}
\caption{Fluxograma de navegação indoor: sensoriamento, localização, rede e destino.}
...
A Figura~\ref{fig:telas} apresenta as principais telas do aplicativo: a busca de
destino por nome de ambiente e a visualização da rota calculada com instrução de
navegação em tempo real.

\begin{figure}[ht]
\centering
\includegraphics[width=.38\textwidth]{tela_busca.png}
\hspace{0.05\textwidth}
\includegraphics[width=.38\textwidth]{tela_navegacao.png}
\caption{Telas do aplicativo: busca por ambiente (esquerda) e navegação ativa (direita).}
\label{fig:telas}
\end{figure}
...
\begin{itemize}
  \item \textbf{Repositório:}
        \href{https://github.com/Jpborgesll/navegacao-indoor-srbc-2026}{github.com/Jpborgesll/navegacao-indoor-srbc-2026}
  \item \textbf{Documentação e instalação:}
        \href{https://github.com/Jpborgesll/navegacao-indoor-srbc-2026#readme}{github.com/Jpborgesll/navegacao-indoor-srbc-2026\#readme}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{4 beacons BLE comerciais} (compatíveis com iBeacon/Eddystone)
        posicionados no espaço de demonstração com distância máxima de 5 metros;
